...
Pet.create(name: "Robert Rubby", animal_type: "Duck", age: 1, home_stay: true, user_id: 3, location: "Unter den Linden 10, 10117 Berlin", remote_photo_url: "http://res.cloudinary.com/novelty142/image/upload/v1527078833/hbkgdxjzr4bwzsi6ba5g.jpg")
Pet.create(name: "Rico", animal_type: "Snake", breed: "Python", age: 20, take_away: true, home_stay: true, adoptable: true, user_id: 2, location:"Potsdamer Straße 188, 10827 Berlin", remote_photo_url: "http://res.cloudinary.com/novelty142/image/upload/v1527079953/mkcpposkwwzlxld4ol4w.jpg")
...
Pet.create(name: "Chi-Chi", animal_type: "Dog", breed: "Pomeranian", age: 1, home_stay: true, user_id: 4, location: "Floßplatz 8, 04107 Leipzig", remote_photo_url: "http://res.cloudinary.com/novelty142/image/upload/v1527242468/pomeranian.jpg")
